...
QUESTIONS = [
    ...
    ("HOROSCOPE_EVERY_DAYS", "Horoscope every N days; 0 disables", False),
    ("DAILY_SUMMARY_TIME", "Daily summary time HH:MM", False),
    ("SUMMARY_EVERY_DAYS", "Summary every N days; 0 disables", False),
    ...
    ("JOKE_EVERY_DAYS", "Joke every N days; 0 disables", False),
    ("CONSPIRACY_TIME", "Conspiracy time HH:MM", False),
    ("CONSPIRACY_EVERY_DAYS", "Conspiracy every N days; 0 disables", False),

...
QUESTIONS = [
    ...
    ("ANSWER_SYSTEM_PROMPT_PATH", "Answer system prompt file path", False),
    ("ANSWER_PROMPT_PATH", "Answer/search prompt file path", False),
...
DEFAULT_PROMPT_TEXTS = {
    ...
    "ANSWER_SYSTEM_PROMPT_PATH": default_prompts.ANSWER_SYSTEM_PROMPT,
    "ANSWER_PROMPT_PATH": default_prompts.ANSWER_PROMPT,
